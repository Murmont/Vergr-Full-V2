...
export default function HelpCenterScreen() {
  ...
  const faqs = [
    {q:'What are coins, gems, and VP?',a:'Coins are bought with real money and spent on tips, tournaments, services, and boosts. Gems are earned when someone spends coins ON YOU (tips, services, tournament prizes) — gems can be cashed out. VP is earned through activity and unlocks levels, perks, and commission discounts.'},
    {q:'How do I earn real money?',a:'Offer services (coaching, editing, design), win tournaments, or receive tips. Clients pay with coins, you receive gems. Cash out gems when you reach 1000 (€10). Your VP level determines your commission rate — from 30% at Rookie down to 15% at Mythic.'},
    ...
    {q:'What is the service marketplace?',a:'List your skills (coaching, editing, design, moderation). Clients pay coins, you receive gems minus your commission rate. Payments are held in escrow until work is delivered and approved.'},
    {q:'Can I make a living on VERGR?',a:'A coach at Rookie level charging 2000 coins/session earns 1400 gems (€14). Five sessions/week = €280/month. At Mythic level: €340/month. Combined with tournament winnings and tips, dedicated users can earn €400-600+/month.'},
  ];
  return (
